import{_ as n}from"./plugin-vue_export-helper-c27b6911.js";import{o as a,c as s,a as e}from"./app-f6a22c71.js";const p={},t=e(`<p>环境函数应该在 Node 端调用，你应该只在 Node 端代码中从 <code>vuepress-shared/node</code> 导入它们。</p><p>所有函数都应该在在返回 API 接口之前在插件函数中被调用。</p><p>如果不支持运行时环境，插件应该返回一个空的 api 接口，例如：</p><div class="language-typescript line-numbers-mode" data-ext="ts"><pre class="language-typescript"><code><span class="token keyword">export</span> <span class="token keyword">const</span> <span class="token function-variable function">examplePlugin</span> <span class="token operator">=</span> <span class="token punctuation">(</span>options<span class="token punctuation">)</span> <span class="token operator">=&gt;</span> <span class="token punctuation">(</span>app<span class="token punctuation">)</span> <span class="token operator">=&gt;</span> <span class="token punctuation">{</span>
