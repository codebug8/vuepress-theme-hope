import{_ as n}from"./plugin-vue_export-helper-c27b6911.js";import{o as s,c as a,f as e}from"./app-1f522f6c.js";const t={},p=e(`<h2 id="链接检查" tabindex="-1"><a class="header-anchor" href="#链接检查" aria-hidden="true">#</a> 链接检查</h2><p><code>vuepress-plugin-md-enhance</code> 默认在开发模式下检查你的 Markdown 链接。</p><p>你可以通过插件选项中的 <code>checkLinks</code> 自定义此功能。 <code>checkLinks</code> 接收一个对象。</p><ul><li>你可以使用 <code>checkLinks.status</code> 自定义链接检查状态，你可以在 <code>&#39;always&#39;</code>、<code>&#39;never&#39;</code>、<code>&#39;dev&#39;</code> 和 <code>&#39;build&#39;</code> 中选择。</li><li>要忽略某些链接，你可以将 <code>checkLinks.ignore</code> 设置为字符串和 RegExp 的数组，或者填入一个接收 link 和 isDev 作为参数并返回一个布尔值以标识是否忽略此链接的函数。</li></ul><p>例如:</p><div class="language-javascript line-numbers-mode" data-ext="js"><pre class="language-javascript"><code><span class="token keyword">export</span> <span class="token keyword">default</span> <span class="token punctuation">{</span>
...
:::
</code></pre></div>`,12),c=[p];function o(i,l){return s(),a("div",null,c)}const u=n(t,[["render",o],["__file","others.html.vue"]]);export{u as default};
