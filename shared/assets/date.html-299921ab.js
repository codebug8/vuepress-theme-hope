import{_ as n}from"./plugin-vue_export-helper-c27b6911.js";import{o as s,c as a,a as e}from"./app-f6a22c71.js";const t={},o=e(`<h3 id="getdateinfo" tabindex="-1"><a class="header-anchor" href="#getdateinfo" aria-hidden="true">#</a> getDateInfo</h3><p>Get date info from a string or Date object.</p><div class="hint-container note"><p class="hint-container-title">Note</p><p>The function returns null instead of throw error when the date is invalid.</p></div><div class="language-typescript line-numbers-mode" data-ext="ts"><pre class="language-typescript"><code><span class="token keyword">export</span> <span class="token keyword">interface</span> <span class="token class-name">DateDetail</span> <span class="token punctuation">{</span>
...
<span class="token comment">// ];</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div></details>`,10),p=[o];function i(l,c){return s(),a("div",null,p)}const d=n(t,[["render",i],["__file","date.html.vue"]]);export{d as default};
